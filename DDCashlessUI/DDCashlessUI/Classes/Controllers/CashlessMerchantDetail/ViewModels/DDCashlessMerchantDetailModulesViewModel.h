//
//  DDCashlessMerchantDetailModulesViewModel.h
//  DDOutletsUI
//
...
@protocol DDCashlessMerchantDetailModulesViewModel @end

@interface DDCashlessMerchantDetailModulesViewModel : JSONModel
