...
@interface DDCinemaWebVC()<SFSafariViewControllerDelegate>{
...
-(void)viewDidLoad {
    if (self.dataModel.request == nil) {
        NSString *url = DDCAppConfigManager.shared.api_config.CINEMA_URL;
