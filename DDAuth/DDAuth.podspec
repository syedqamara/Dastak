#
# Be sure to run `pod lib lint DDAuth.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'DDAuth'
  s.version          = '0.1.0'
  s.summary          = 'A short description of DDAuth.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'DDAuth/Classes/**/*.[^xib]*'
  s.subspec 'Resources' do |resources|
      resources.resource_bundle = {'Images' => ['DDAuth/Assets/**/*.{xcassets,png,gif}'],'Jsons' => ['DDAuth/Assets/Jsons/**/*.{json,png}'],'Nibs' => ['DDAuth/Classes/**/*.{xib}']}
  end
  # s.resource_bundles = {
